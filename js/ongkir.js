    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .logo-kop { 
            ...
            left: 5mm; /* Jarak dari batas dalam kertas */
            top: -5mm; /* Jarak dari batas dalam kertas */
        }
        ...
        /* Footer & Tanda Tangan */
                .footer-sign { margin-top: auto; padding-top: 60px; } /* Memberikan jarak dari konten di atas ke footer */
                .sign-table {
        ...
        ${['ASLI', 'COPY'].map(type => `
            <div class="sisi-kertas">
                <div class="header-kop">
                    <img src="${logoUrl}" class="logo-kop">
